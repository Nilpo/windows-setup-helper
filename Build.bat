...
REM (Optional) Location of $OEM$ directory to be copied to the root of the finished ISO (no $OEM$, no trailing slash)
...
if exist "%oemfiles%\$OEM$\" ( robocopy "%oemfiles%\$OEM$" "%mediapath%\$OEM$" /E /R:2 /W:55 /NFL /NDL /NJH /NJS /NP)
